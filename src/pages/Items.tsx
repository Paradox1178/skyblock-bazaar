...
const Items = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white">
      {/* Header Bereich mit Tiefenwirkung */}
      ...
      <div className="container mx-auto px-4 max-w-7xl pb-20">
        {/* Kategorien als Minecraft Buttons */}
        ...
        {/* Hinweis bei vielen Treffern */}
        {hasMore && (
          <div className="mt-12 p-6 bg-[#252525] border-2 border-dashed border-[#333] text-center rounded-lg">
            <p className="text-gray-500 text-sm italic">
              Zeige die ersten {ITEMS_PER_PAGE} Ergebnisse. 
              Nutze die Suche, um gezielter zu finden.
            </p>
          </div>
        )}
      </div>
