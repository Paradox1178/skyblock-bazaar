    ...
    >
      ...
      >
        ...
        <div className="space-y-4 text-sm text-gray-300">
          <p>
            Die Anmeldung erfolgt jetzt <span className="text-yellow-500 font-bold">nur ingame über die Mod</span>.
          </p>
          ...
          <div className="bg-black/20 border border-[#333] p-4 space-y-2">
            ...
            <ol className="list-decimal ml-5 space-y-1 text-gray-300">
              ...
              <li>Den Login-Befehl in der Mod ausführen</li>
              <li>Den erzeugten Link im Browser öffnen</li>
